...
Requires:       ros-eloquent-pluginlib >= 1.9.23
Requires:       ros-eloquent-qt-gui >= 0.3.0
Requires:       ros-eloquent-tinyxml2-vendor
Requires:       ros-eloquent-ros-workspace
BuildRequires:  pkgconfig
BuildRequires:  qt5-qtbase-devel
BuildRequires:  ros-eloquent-ament-cmake
BuildRequires:  ros-eloquent-ament-cmake-pytest
BuildRequires:  ros-eloquent-pluginlib >= 1.9.23
BuildRequires:  ros-eloquent-python-qt-binding >= 0.3.0
BuildRequires:  ros-eloquent-tinyxml2-vendor
...
%changelog
* Fri Sep 18 2020 Dirk Thomas <dthomas@osrfoundation.org> - 1.0.9-1
