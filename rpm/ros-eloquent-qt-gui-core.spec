...
Requires:       ros-eloquent-qt-dotgraph >= 0.3.0
Requires:       ros-eloquent-qt-gui >= 0.3.0
Requires:       ros-eloquent-qt-gui-app >= 0.3.0
Requires:       ros-eloquent-qt-gui-cpp >= 0.3.0
Requires:       ros-eloquent-qt-gui-py-common >= 0.3.0
