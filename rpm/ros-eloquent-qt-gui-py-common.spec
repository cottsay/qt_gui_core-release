...
Name:           ros-eloquent-qt-gui-py-common
Version:        1.0.9
...
Requires:       ros-eloquent-ament-index-python
Requires:       ros-eloquent-python-qt-binding
...
%changelog
* Fri Sep 18 2020 Dorian Scholz <scholz@sim.tu-darmstadt.de> - 1.0.9-1
